            ...
            columnDefs: [
                {
                    ...
                    render: function (data, type, row) {
                        ...
                        <div class="">
                            ...
                            <a  id="edit-data" data-id="${row.id}" data-bs-toggle="modal" data-bs-target="#editCategoryModal" class="btn btn-icon btn-bg-light btn-primary btn-active-color-secondary btn-sm me-1">
    ...
    var handleDeleteRows = () => {
        ...
        deleteButtons.forEach((d) => {
            ...
            d.addEventListener("click", function (e) {
                ...
                // Get customer name
                const category = parent.querySelectorAll("td")[1].innerText;
                ...
                Swal.fire({
                    ...
                    if (result.value) {
                        $.ajax({
                            type: "DELETE",
                            url: route("category-data.destroy", kode),
                            data: {
                                _token: csrf,
                            },
                            success: function (response) {
                                Swal.fire({
                                    text: "You have deleted " + category + "!.",
                                    icon: "success",
                                    buttonsStyling: false,
