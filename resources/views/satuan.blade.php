...
@section('script')
    <script src="{{ asset('table/satuan-table.js') }}"></script>
    <script src="{{ asset('crud/satuan/add.js') }}"></script>
    <script src="{{ asset('crud/satuan/edit.js') }}"></script>
    <script>
        // $(document).ready(function() {
        //     $('#category').select2({
        //         dropdownParent: $("#addSatuanModal")
        //     });
        // });
      </script>
@endsection
...
<div class="max-w-7xl mx-auto p-6 lg:p-8"  style="margin-top: 50px">
            ...
            <div  class="p-6 bg-white dark:bg-gray-800/50 dark:bg-gradient-to-bl from-gray-700/50 via-transparent dark:ring-1 dark:ring-inset dark:ring-white/5 rounded-lg shadow-2xl shadow-gray-500/20 dark:shadow-none  motion-safe:hover:scale-[1.01] transition-all duration-250 focus:outline focus:outline-2 focus:outline-red-500">
                <div class="">
                    <div class="flex ">
                        ...
                        <h2 class="mt-3  text-xl font-semibold text-gray-900 ">&nbsp; Data Satuan Item</h2>
                    </div>
                    
                    <div class="table-responsive">
                        <div class="d-flex justify-content-end">
                            <button  class="text-end bg-success p-2 text-white rounded " data-bs-toggle="modal" data-bs-target="#addSatuanModal">Add Satuan</button>
                        </div>
                        <table class="table table-striped" id="satuan_table">
                            <thead>
                                <tr>
                                    <th scope="col">No</th>
    ...
    <div class="modal fade" id="addSatuanModal"  role="dialog" aria-labelledby="addSatuanModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 900px">
          <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="add_satuan" method="POST">
                    @csrf
    ...
    <div class="modal fade" id="editSatuanModal"  role="dialog" aria-labelledby="editCategoryModalTitle" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered" role="document" style="max-width: 900px">
          <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
                <form id="edit_satuan" method="POST">
                    @csrf
                    @method('PUT')
                    <div class="row fv-row mb-3">
                        <div class="form-group">
